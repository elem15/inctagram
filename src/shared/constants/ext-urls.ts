...
export const AUTH_URLS = {
  ...
  GOOGLE: `https://accounts.google.com/o/oauth2/v2/auth?scope=email profile&include_granted_scopes=true&response_type=code&redirect_uri=${FRONTEND_URL}&client_id=${CLIENT_ID}`,
}
